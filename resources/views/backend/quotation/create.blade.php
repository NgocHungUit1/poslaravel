                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>{{ trans('file.Image') }} 2</label> <i class="dripicons-question"
                                                    data-toggle="tooltip"
                                                    title="Only jpg, jpeg, png, gif, pdf, csv, docx, xlsx and txt file is supported"></i>
    ...
    if (id) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (flag) {
                            ...
                            if (data[12])
                                cols +=
                                '<td><input type="text" class="form-control batch-no" required/> <input type="hidden" class="product-batch-id" name="product_batch_id[]"/> </td>';
                            else
                                cols +=
        ...
        function calculateRowProductData(quantity) {
            ...
            if (tax_method[rowindex] == 1) {
                ...
                $('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ')').find('.net_price').text(net_price.toFixed(
                    {{ $general_setting->decimal }}));
