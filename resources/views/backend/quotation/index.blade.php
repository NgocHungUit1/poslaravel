    ...
    <script type="text/javascript">
        ...
        function quotationDetails(quotation) {
            ...
            htmltext += '<div class="col-md-6">' +
                ...
                '<strong>{{ trans('file.Status') }}: </strong>' + quotation[2] + '<br>';

            // Thêm thông tin đính kèm nếu có
            if (quotation[28]) {
                htmltext += '<strong>{{ trans('file.Attach Document') }}: </strong>' +
                    '<a href="documents/quotation/' + quotation[28] + '">Download</a><br>';
            }
            htmltext += '</div>';
            ...
            htmltext += '<hr><div class="row mt-3">' +
                '<div class="col-md-6">' +
                '<strong>{{ trans('file.From') }}:</strong><br>' +
                quotation[3] + '<br>' + // Biller name
                quotation[4] + '<br>' + // Company name
                quotation[5] + '<br>' + // Email
                quotation[6] + '<br>' + // Phone
                quotation[7] + '<br>' + // Address
                quotation[8] + // City
                '</div>' +
                '<div class="col-md-6">' +
                '<strong>{{ trans('file.To') }}:</strong><br>' +
                '<input type="text" id="customer_name" class="form-control mb-2" value="' + quotation[9] + '" />' +
                // Customer name
                '<input type="text" id="customer_phone" class="form-control mb-2" value="' + quotation[10] + '" />' +
                // Phone
                '<input type="text" id="customer_address" class="form-control mb-2" value="' + quotation[11] + '" />' +
                // Address
                '<input type="text" id="customer_city" class="form-control mb-2" value="' + quotation[12] + '" />' + // City
                '</div></div>';
            ...
            $.get('quotations/product_quotation/' + quotation[13], function(data) {
                ...
                cols += '<td>' + quotation[23] + '</td>'; // Paid Amount
                newRow.append(cols);
                newBody.append(newRow);
                ...
                newRow = $("<tr>");
                cols = '';
                cols += '<td colspan=7 class="text-danger"><strong>{{ trans('file.Debt Amount') }}:</strong></td>';
            ...
            var htmlfooter = '<hr><div class="row mt-3">' +
                '<div class="col-md-12">' +
