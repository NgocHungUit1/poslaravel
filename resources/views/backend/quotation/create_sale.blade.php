                                                ...
                                                <table id="myTable" class="table table-hover order-list">
                                                            ...
                                                            <tr>
                                                                ...
                                                                if ($product_quotation->variant_id) {
                                                                    $product_variant_data = \App\Models\ProductVariant::select('item_code')
                                                                        ->FindExactProduct($product_quotation->product_id, $product_quotation->variant_id)
                                                                        ->first();
                                                                ...
                                                                $tax = DB::table('taxes')
                                                                    ->where('rate', $product_quotation->tax_rate)
                                                                    ->first();
                                                                ...
                                                                @if ($product_batch_data)
                                                                    <td>
                                                                        <input type="hidden" class="product-batch-id"
                                                                            ...
                                                                            value="{{ $product_quotation->product_batch_id }}">
                                                                ...
                                                                <td><input type="number" class="form-control qty"
                                                                        name="qty[]"
                                                                        value="{{ $product_quotation->qty }}"
                                                                        step="any" required /></td>
                                                                <td class="net_unit_price">
                                                                    {{ number_format((float) $product_quotation->net_unit_price, $general_setting->decimal, '.', '') }}
                                                                </td>
                                                                <td class="discount">
                                                                    {{ number_format((float) $product_quotation->discount, $general_setting->decimal, '.', '') }}
                                                                </td>
                                                                <td class="tax">
                                                                    {{ number_format((float) $product_quotation->tax, $general_setting->decimal, '.', '') }}
                                                                </td>
                                                                <td class="sub-total">
                                                                    {{ number_format((float) $product_quotation->total, $general_setting->decimal, '.', '') }}
                                                                </td>
                                                    ...
                                                    <tfoot class="tfoot active">
                                                        ...
                                                        <th id="total-discount">
                                                            {{ number_format((float) $lims_quotation_data->total_discount, $general_setting->decimal, '.', '') }}
                                                        </th>
                                                        <th id="total-tax">
                                                            {{ number_format((float) $lims_quotation_data->total_tax, $general_setting->decimal, '.', '') }}
                                                        </th>
                                                        <th id="total">
                                                            {{ number_format((float) $lims_quotation_data->total_price, $general_setting->decimal, '.', '') }}
                                                        </th>
                                                        <th><i class="dripicons-trash"></i></th>
                                                    </tfoot>
                                                </table>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <input type="hidden" name="item"
                                                    value="{{ $lims_quotation_data->item }}" />
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="order_discount_value" class="form-control"
                                                    id="order-discount-val"
                                                    value="{{ $lims_quotation_data->order_discount }}">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select name="payment_status" class="form-control">
                                                    <option value="1"
                                                        {{ $lims_quotation_data->payment_status == 1 ? 'selected' : '' }}>
                                                        {{ trans('file.Pending') }}</option>
                                                    <option value="2"
                                                        {{ $lims_quotation_data->payment_status == 2 ? 'selected' : '' }}>
                                                        {{ trans('file.Due') }}</option>
                                                    <option value="3"
                                                        {{ $lims_quotation_data->payment_status == 3 ? 'selected' : '' }}>
                                                        {{ trans('file.Partial') }}</option>
                                                    <option value="4"
                                                        {{ $lims_quotation_data->payment_status == 4 ? 'selected' : '' }}>
                                                        {{ trans('file.Paid') }}</option>
                                                </select>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                @if (isset($lims_quotation_data->document) && $lims_quotation_data->document)
                                                    <input type="hidden" name="current_document"
                                                        value="{{ $lims_quotation_data->document }}">
                                                    <div>
                                                        <img src="{{ asset('/images/quotation/' . $lims_quotation_data->document) }}"
                                                            alt="Hình ảnh" style="max-width: 20%" />
                                                    </div>
                                                @endif
                                            ...
                                            <div class="form-group">
                                                ...
                                                @if (isset($lims_quotation_data->image) && $lims_quotation_data->image)
                                                    <input type="hidden" name="current_image"
                                                        value="{{ $lims_quotation_data->image }}">
                                                    <div>
                                                        <img src="{{ asset('/images/quotation/' . $lims_quotation_data->image) }}"
                                                            alt="Hình ảnh" style="max-width: 20%" />
                                                    </div>
                                                @endif
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <select name="paid_by_id[]" class="form-control">
                                                        <option value="1"
                                                            {{ $lims_quotation_data->payment_method == 'Cash' ? 'selected' : '' }}>
                                                            Cash</option>
                                                        <option value="3"
                                                            {{ $lims_quotation_data->payment_method == 'Credit Card' ? 'selected' : '' }}>
                                                            Credit Card</option>
                                                        <option value="5"
                                                            {{ $lims_quotation_data->payment_method == 'Paypal' ? 'selected' : '' }}>
                                                            Paypal</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="paid_amount[]" class="form-control"
                                                        ...
                                                        value="{{ $lims_quotation_data->paid_amount }}" />
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="paying_amount[]" class="form-control"
                                                        id="paying-amount" step="any" readonly
                                                        value="{{ $lims_quotation_data->debt }}" />
                                                </div>
                                            </div>
...
@push('scripts')
    <script type="text/javascript">
        ...
        // Lấy giá trị payment status ban đầu
        var initial_payment_status = $('select[name="payment_status"]').val();

        // Xử lý hiển thị ban đầu
        handlePaymentStatus(initial_payment_status);

        // Xử lý khi thay đổi payment status
        $('select[name="payment_status"]').on('change', function() {
            handlePaymentStatus($(this).val());
        });
        ...
        function handlePaymentStatus(status) {
            if (status == 3 || status == 4) { // Partial hoặc Paid
                $("#payment").show();
                $("#paying-amount").prop('required', true);
                $("#paid-amount").prop('required', true);

                // Nếu là status Paid thì set giá trị và disable
                if (status == 4) {
                ...
                // Kiểm tra và hiển thị các trường theo phương thức thanh toán
        ...
        function handlePaymentMethod(method) {
            ...
            // Reset các trường required
            $('input[name="cheque_no"]').attr('required', false);
            $('select[name="gift_card_id"]').attr('required', false);

            // Hiển thị trường tương ứng theo phương thức
            switch (method) {
                case "2": // Gift Card
                    $("#gift-card").show();
                ...
                case "6": // Deposit
                    var customer_deposit = deposit[$('#customer_id').val()];
                    if ($('input[name="paid_amount[]"]').val() > customer_deposit) {
                        alert('Amount exceeds customer deposit! Customer deposit : ' + customer_deposit);
                    }
                    break;
            }
        }
        ...
        $('#order_discount').text(parseFloat($('input[name="order_discount_value"]').val()).toFixed(
        ...
        $('input[name="paid_amount[]"]').on("input", function() {
            ...
            $('input[name="paying_amount[]"]').val(remaining.toFixed({{ $general_setting->decimal }}));
        });
