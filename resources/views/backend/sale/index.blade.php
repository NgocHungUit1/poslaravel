    ...
    <section>
        <div class="container-fluid">
            @if (in_array('sales-add', $all_permission))
                <a href="{{ route('sales.create') }}" class="btn btn-info add-sale-btn"><i class="dripicons-plus"></i>
                    {{ trans('file.Add Sale') }}</a>&nbsp;
                <a href="{{ url('sales/sale_by_csv') }}" class="btn btn-primary add-sale-btn"><i class="dripicons-copy"></i>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mt-1 d-none">
    ...
    <div id="add-delivery" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true"
        ...
        <div role="document" class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    {!! Form::open(['route' => 'delivery.store', 'method' => 'post', 'files' => true, 'id' => 'delivery-form']) !!}
                    <div class="row">
...
<div class="delivery-info">
    ...
    <!-- Hàng mới cho thông tin giao hàng -->
    <div class="row">
        <div class="col-md-12">
            <div class="bordered-box customer">
...
`;
        ...
        $(document).ready(function() {
            ...
            $('#delivery-form').on('submit', function(e) {
                ...
                let form = $(this); // Lấy form
                let submitButton = form.find('button[type="submit"]'); // Lấy nút submit
                submitButton.prop('disabled', true).text('Submitting...'); // Disable nút và đổi nội dung

                let formData = new FormData(this); // Lấy toàn bộ dữ liệu từ form

                $.ajax({
                    url: form.attr('action'), // Lấy URL từ thuộc tính action của form
                    method: form.attr('method'), // Lấy method từ thuộc tính method của form
                    data: formData,
                    contentType: false,
                    processData: false,
                    ...
                    error: function(xhr) {
                        ...
                        alert("An error occurred while adding delivery. Please try again.");
                    },
                    complete: function() {
                        // Hoàn thành, bật lại nút submit
        ...
        document.getElementById('paying_amount').addEventListener('input', function() {
            document.getElementById('amount').value = this.value; // Đồng bộ giá trị
        });

        document.getElementById('amount').addEventListener('input', function() {
            document.getElementById('paying_amount').value = this.value; // Đồng bộ giá trị
        });
    </script>
    <style>
