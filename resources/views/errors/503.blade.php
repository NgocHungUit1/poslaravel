        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 offset-md-3  error-text text-center">
                    ...
                    <h2 class="h1">{{trans("file.We'll be back soon!")}}</h2>
                    <p class="lead">{{trans("file.Sorry for the inconvenience. We're performing some working to improve your experience and will be back online shortly!")}}
                </div>
            </div>
        </div>
    </section>
